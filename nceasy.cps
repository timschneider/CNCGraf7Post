/**
  Post processor configuration for NC EAS(Y) modified by Tim Schneider (tim@schneider.engineering)
...
description = "NC EAS(Y)";
vendor = "EAS GmbH";
vendorUrl = "https://www.easgmbh.de";
legal = "Copyright (C) 2017 by Tim Schneider Engieering UG(haftungsbeschränkt).";
certificationLevel = 2;
minimumRevision = 24000;

longDescription = "Specific post for the RS-274D format of NC EAS(Y) without circular XZ and XY moves.";
...
var gUnitModal = createModal({}, gFormat); // modal group 6 // G27-71
